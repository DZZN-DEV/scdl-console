...
public class MainActivity extends PythonConsoleActivity {
                    ...
                    if (downloadPathUri != null) {
                        try {
                            ...
                            if (downloadPath != null) {
                                ...
                                showToast("Invalid download path selected.");
                            }
                        } catch (Exception e) {
                            showToast("Error selecting path: " + e.getMessage());
                        }
                    }
                } else {
                    showToast("Failed to select directory. Please try again.");
                }
            });
    ...
    private void executeDownload() {
        ...
        if (downloadPath == null) {
            showToast("Please select a download path");
            return;
        }
    ...
    private void openDirectoryPicker() {
        ...
        try {
            ...
            showToast("Error opening directory picker: " + e.getMessage());
        }
    }
    ...
    private String getPathFromUri(Uri uri) {
        ...
        try {
            ...
            showToast("Error retrieving file path: " + e.getMessage());
        }
        return filePath;
    }
    ...
    private String getDataColumn(Context context, Uri uri, String selection, String[] selectionArgs) {
        ...
        try {
            ...
            showToast("Error querying data column: " + e.getMessage());
        } finally {
            if (cursor != null) {
                cursor.close();
            }
